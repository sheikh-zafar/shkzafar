          ...
          <div className="container">
            <div className="row text-center d-flex justify-content-center">
              <div className="col-md-6 d-flex justify-content-end">
                ...
                >
                  <i class="fa fa-whatsapp" aria-hidden="true"></i> GROUP 1
                </a>
              </div>
          ...
          <div className="container">
            <div className="row text-center d-flex justify-content-center">
              <div className="col-md-6 d-flex justify-content-end">
                ...
                >
                  <i class="fa fa-whatsapp" aria-hidden="true"></i> GROUP 3
                </a>
              </div>
              <div className="col-md-6 d-flex justify-content-start">
                <a
                ...
                >
                  <i class="fa fa-whatsapp" aria-hidden="true"></i> GROUP 4
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row text-center d-flex justify-content-center">
              <div className="col-md-6 d-flex justify-content-end">
                ...
                >
                  <i class="fa fa-whatsapp" aria-hidden="true"></i> GROUP 5
                </a>
              </div>
              <div className="col-md-6 d-flex justify-content-start">
                <a
                ...
                >
                  <i class="fa fa-whatsapp" aria-hidden="true"></i> GROUP 6
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row text-center d-flex justify-content-center">
              <div className="col-md-6 d-flex justify-content-end">
                ...
                >
                  <i class="fa fa-whatsapp" aria-hidden="true"></i> GROUP 7
                </a>
              </div>
              <div className="col-md-6 d-flex justify-content-start">
                <a
                ...
                >
                  <i class="fa fa-whatsapp" aria-hidden="true"></i> GROUP 8
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row text-center d-flex justify-content-center">
              <div className="col-md-6 d-flex justify-content-end">
                ...
                >
                  <i class="fa fa-headphones" aria-hidden="true"></i> Mixlr live
                </a>
              </div>
              <div className="col-md-6 d-flex justify-content-start">
                <a
                ...
                >
                  <i class="fa fa-headphones" aria-hidden="true"></i> Showreel
                </a>
              </div>
            </div>
          </div>
