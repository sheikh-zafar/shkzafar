      ...
      <div>
        <div className="application">
          <Helmet>
            ...
            <meta
              name="title"
              content="Jummuah Khutbah - Listen and Download Jummuah Khutbah bu zafar ul hasan madani"
            />
            <meta
              name="description"
              content="Listen and Download Jummuah Khutbah by zafar ul hasan madani"
            />
          </Helmet>
        </div>
        <Navbar />
